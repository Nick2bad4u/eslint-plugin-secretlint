...
- [`🟡`](./recommended.md) — [`secretlint.configs.recommended`](./recommended.md)
- [`🧪`](./secretlint-only.md) — [`secretlint.configs.secretlintOnly`](./secretlint-only.md)
- [`🔧`](./configuration.md) — [`secretlint.configs.configuration`](./configuration.md)
- [`🟣`](./all.md) — [`secretlint.configs.all`](./all.md)

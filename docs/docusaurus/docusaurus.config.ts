...
const projectTagline = "Secret scanning feedback inside ESLint.";
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            label: "Bridge Guide",
                            to: "/docs/rules/guides/secretlint-bridge",
                        },
                        {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: "Secretlint Only",
                            to: "/docs/rules/presets/secretlint-only",
                        },
                        {
                            label: "Configuration",

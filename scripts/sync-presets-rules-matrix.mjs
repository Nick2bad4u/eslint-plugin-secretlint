...
const pluginNamespace = builtPlugin.meta?.namespace ?? "secretlint";
const presetDocsByName = {
    all: {
        href: "./all.md",
        icon: "🟣",
        path: resolve("docs", "rules", "presets", "all.md"),
        publicName: "secretlint.configs.all",
    },
    configuration: {
        href: "./configuration.md",
        icon: "🔧",
        path: resolve("docs", "rules", "presets", "configuration.md"),
        publicName: "secretlint.configs.configuration",
    },
    recommended: {
        href: "./recommended.md",
        icon: "🟡",
        path: resolve("docs", "rules", "presets", "recommended.md"),
        publicName: "secretlint.configs.recommended",
    },
    secretlintOnly: {
        href: "./secretlint-only.md",
        icon: "🧪",
        path: resolve("docs", "rules", "presets", "secretlint-only.md"),
        publicName: "secretlint.configs.secretlintOnly",
    },
};

...
import type { SecretlintConfigReference } from "./secretlint-config-references.js";
...
/**
 * SecretlintRuleDocs secretlint rule docs contract.
 */
export type SecretlintRuleDocs = Readonly<{
    configs: readonly SecretlintConfigReference[] | SecretlintConfigReference;
    description: string;
    frozen?: boolean;
    recommended: boolean;

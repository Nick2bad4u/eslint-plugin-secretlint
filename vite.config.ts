...
const rawHangingReporterFlag =
    process.env["SECRETLINT_VITEST_HANGING_PROCESS_REPORTER"] ??
...
/**
 * Vitest configuration for eslint-plugin-secretlint.
 */
    ...
    test: {
        ...
        coverage: {
            ...
            exclude: [
                ...
                "shared",
                "shared/test",
                "src/_internal/secretlint-worker.ts", // Covered through worker integration; V8 cannot merge worker-thread instrumentation here.
